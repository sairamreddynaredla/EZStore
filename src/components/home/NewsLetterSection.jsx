      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 md:mb-20 text-center md:text-left">
          <div className="flex items-center justify-center md:justify-start gap-3 mb-6">
            ...
            <p className="text-sm uppercase tracking-[3px] font-bold text-red-500">
              Stay Updated
            </p>
          </div>
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-3xl leading-relaxed">
            Join our community of pet lovers and receive curated product recommendations, nutrition guides, wellness tips, and limited-time offers delivered straight to your inbox.
          </p>
        </div>
              ...
              <div className="text-white">
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <p className="text-gray-300 text-lg leading-relaxed">
                    Get personalized pet care recommendations and be the first to know about new products.
                  </p>
                </div>
              ...
              <div className="bg-white rounded-2xl p-8 md:p-10 shadow-2xl">
                ...
                {status === "success" && (
                  <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl flex items-start gap-3">
                    ...
                    <p className="text-green-800 font-medium">Thanks for subscribing! Check your email for confirmation.</p>
                  </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label htmlFor="newsletter-name" className="block text-sm font-semibold text-gray-900 mb-2">
                      Full Name
                    </label>
                    <input
                      id="newsletter-name"
                  ...
                  <div>
                    <label htmlFor="newsletter-email" className="block text-sm font-semibold text-gray-900 mb-2">
                      Email Address
                    </label>
                    <input
                      id="newsletter-email"
