import tetraImg from "../../assets/products/fish/tetra-tetramin-tropical-flakes-fish-food.jpg";
import hikariImg from "../../assets/products/fish/hikari-tropical-micro-pellets-fish-food.jpg";
import omegaOneImg from "../../assets/products/fish/omega-one-super-color-flakes-fish-food.jpg";
import fluvalImg from "../../assets/products/fish/fluval-bug-bites-tropical-formula-fish-food.jpg";
import seraImg from "../../assets/products/fish/sera-vipan-nature-tropical-fish-food.jpg";
import apiImg from "../../assets/products/fish/api-tropical-pellets-fish-food.jpg";
...
export const fishFood = [
  ...
  description:
    "Complete daily nutrition flake food suitable for most tropical fish species.",
...

{
  ...
  description:
    "Premium micro pellets designed for tropical fish with superior digestibility.",
...
},
{
  ...
  description:
    "Natural salmon-based flakes formulated to improve fish coloration and vitality.",
...

{
  ...
  description:
    "Insect-based tropical fish food inspired by the natural diet of wild fish.",
...

{
  ...
  description:
    "Natural tropical fish flakes without artificial colors or preservatives.",
