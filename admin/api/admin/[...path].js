...
const FRONTEND_URL = process.env.FRONTEND_URL || (process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : "https://ezstore-admin.vercel.app");
...
const getRequestPath = (req) => {
  ...
  return url.pathname.replace(/^\/api\/admin/, "") || "/";
};
