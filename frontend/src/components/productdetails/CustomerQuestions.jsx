    ...
    <div className="mt-6">
      ...
      <div className="mt-4">
        <button
          ...
          className="px-4 py-2 rounded border border-gray-300 text-slate-700 hover:bg-gray-50"
        >
          Ask a question
        </button>
        ...
        {showForm && (
          <form className="mt-3 space-y-2">
            ...
            <div className="flex gap-2">
              <button className="px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white rounded">
                Submit
              </button>
              <button
                type="button"
