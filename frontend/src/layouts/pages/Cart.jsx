...
const Cart = () => {
  ...
  const { cartItems, totalPrice, saveForLater, removeFromCart, increaseQuantity, decreaseQuantity, clearCart } =
    useCart();
  ...
  // Save for later
  const handleSaveForLater = async (id, weight) => {
    await saveForLater(id, weight);
  };
