import royalCaninVegImg from "../../assets/products/dogs/vegetarian-food/royal-canin-vegetarian-adult-dry-dog-food.jpg";
import farminaVegImg from "../../assets/products/dogs/vegetarian-food/farmina-vet-life-vegetarian-formula-dog-food.jpg";
import droolsVegImg from "../../assets/products/dogs/vegetarian-food/drools-vegetarian-adult-dog-food.jpg";
import purepetVegImg from "../../assets/products/dogs/vegetarian-food/purepet-vegetarian-adult-dog-food.jpg";
import pedigreeVegImg from "../../assets/products/dogs/vegetarian-food/pedigree-vegetarian-adult-dry-dog-food.jpg";
export const dogsVegetarianFood = [
  ...
  description:
    "Complete vegetarian nutrition formulated for adult dogs with food sensitivities.",
...
},
{
  ...
  description:
    "Premium vegetarian formula enriched with vitamins and antioxidants.",
  ...
  variants: [
    ...
    { weight: "10kg", price: 84.99, originalPrice: 99.99 },
  ],
