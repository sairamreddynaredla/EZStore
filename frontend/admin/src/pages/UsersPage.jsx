  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <button type="button" onClick={openCreateModal} className="inline-flex items-center justify-center rounded-2xl bg-[#1F6B52] px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#1A5844]">
            Add admin user
          </button>
        }
      />
          ...
          <div className="w-full max-w-2xl rounded-3xl bg-white p-6 shadow-2xl">
            ...
            <form className="mt-6 space-y-4" onSubmit={handleSave}>
              ...
              <div className="flex items-center justify-end gap-3 border-t border-slate-200 pt-4">
                ...
                <button type="submit" disabled={saving} className="rounded-2xl bg-[#1F6B52] px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#1A5844] disabled:cursor-not-allowed disabled:bg-slate-300">{saving ? "Saving..." : editingUser ? "Save changes" : "Create admin user"}</button>
              </div>
            </form>
          </div>
        </div>
