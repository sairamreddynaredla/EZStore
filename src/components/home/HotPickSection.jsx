...
const hotPicks = [
  {
    ...
    image: "/images/hotpicks/vet.webp",
    products: 24,
  },

  {
    ...
    image: "/images/hotpicks/puppy.webp",
    products: 18,
  },

  {
    ...
    image: "/images/hotpicks/cat.webp",
    products: 16,
  },

  {
    ...
    image: "/images/hotpicks/protein.webp",
    products: 30,
  },
];
...
const featuredProducts = [
  {
    ...
    image: "/images/products/dog-food-5.webp",
    price: 129,
    oldPrice: 159,
    rating: 4.9,
  },

  {
    ...
    image: "/images/products/cat-food-2.webp",
    price: 94,
    oldPrice: 110,
    rating: 4.8,
  },

  {
    ...
    image: "/images/products/dog-food-1.webp",
    price: 78,
    oldPrice: 99,
    rating: 5.0,
  },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
            Discover premium nutrition, care essentials, and trending products handpicked for every
            stage of your pet’s journey.
          </p>
        </div>
          ...
          {hotPicks.map((item) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-5">{item.subtitle}</p>

                <div className="flex items-center justify-between">
                  <span className="text-red-500 font-semibold">{item.products}+ Products</span>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12">
            ...
            <div className="max-w-xl">
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-8">
                Premium quality food designed for healthy digestion, strong immunity, and happier
                pets.
              </p>
