...
const trustFeatures = [
...

  {
    ...
    description: "Premium packaging and quick shipping designed for safe doorstep delivery.",
  },

  {
    ...
    description: "Curated nutrition and wellness products recommended for healthy pets.",
  },

  {
    ...
    description: "Thousands of pet parents trust eZSTORE for quality products and care.",
  },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8 mb-20">
          {trustFeatures.map((item) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-5 leading-snug">{item.title}</h3>
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10">
            ...
            <div className="max-w-2xl">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6">
                Building A Better Experience For Pet Parents
              </h2>

              <p className="text-gray-300 text-lg leading-relaxed">
                From premium food to trusted care essentials, eZSTORE is focused on making pet
                parenting simpler, healthier, and more joyful.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              <Link
                to="/"
                className="bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 text-white px-8 py-5 rounded-2xl font-semibold transition"
              >
                Learn More
              </Link>
            </div>
