...
const BrandsMega = ({ isOpen, onOpen, onClose }) => {
  ...
  const letters = [
    "All",
    ...Array.from(new Set(allBrands.map((b) => (b.name || "").charAt(0).toUpperCase()))),
  ];
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      <div
        ...
        style={{ top: topOffset }}
        className={
          "absolute left-0 right-0 z-50 transition-all duration-150 " +
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className={`px-4 py-2 rounded-full text-sm font-medium transition ${selectedTab === "Popular" ? "bg-[#1F6B52] text-white" : "bg-white text-gray-700 border border-gray-200"}`}
                    >
                      Popular
                    </button>
                    <button
                      ...
                      className={`px-4 py-2 rounded-full text-sm font-medium transition ${selectedTab === "Emerging" ? "bg-[#1F6B52] text-white" : "bg-white text-gray-700 border border-gray-200"}`}
                    >
                      Emerging
                    </button>
                  </div>
