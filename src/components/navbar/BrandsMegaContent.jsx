          ...
          <div className="sticky top-4 space-y-4">
            ...
            <div className="space-y-3">
              {spotlightEntries.slice(0,3).map((s, idx)=> (
                <Link key={idx} to={`/brands/${s.key}?preset=dog-puppy-food`} onClick={() => onClose && onClose()} className={`w-full block rounded-2xl overflow-hidden border bg-white border-gray-100`}>
