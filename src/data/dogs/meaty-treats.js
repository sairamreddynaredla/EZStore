import pedigreeRodeoImg from "../../assets/products/dogs/meaty-treats/pedigree-rodeo-chicken-treats.webp";
import jerhighChickenJerkyImg from "../../assets/products/dogs/meaty-treats/jerhigh-chicken-jerky-treats.webp";
// smartHeartStickImg removed; SmartHeart brand being hidden
import gnawlersMilkBoneImg from "../../assets/products/dogs/meaty-treats/gnawlers-calcium-milk-bone-treats.webp";
import droolsSausageImg from "../../assets/products/dogs/meaty-treats/drools-real-chicken-sausage-treats.webp";
...
export const dogsMeatyTreats = [
  {
    ...
    images: [pedigreeRodeoImg, pedigreeRodeoImg, pedigreeRodeoImg, pedigreeRodeoImg],
...

  {
    ...
    images: [gnawlersMilkBoneImg, gnawlersMilkBoneImg, gnawlersMilkBoneImg, gnawlersMilkBoneImg],

    description:
      "Gnawlers Calcium Milk Bone Treats help support healthy teeth and bones while providing a delicious chewing experience.",

    ingredients: ["Chicken", "Milk Solids", "Calcium", "Cereals", "Minerals", "Vitamins"],
...

  {
    ...
    images: [droolsSausageImg, droolsSausageImg, droolsSausageImg, droolsSausageImg],
